...
public class PruebaCodigo {
    ...
    public static void main(String[] args) {
        ...
        ConjuntoDePalabras palabrasrepetidas = new ConjuntoDePalabras();
        ...
        palabrasrepetidas = palabrasrepetidas.obtenPalabrasRepetidas(conjunto1,conjunto2);
        palabrasrepetidas.imprimirPantalla();
